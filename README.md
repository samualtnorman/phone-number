...
## Difference from Google's `libphonenumber`
  ...
  * Smaller footprint: 130 kB (55 kB code + 75 kB sufficient metadata) vs the original Google's 530 kB (330 kB code + 200 kB full metadata).
  ...
  * Doesn't use hyphens and brackets when formatting international phone numbers, only whitespace.
